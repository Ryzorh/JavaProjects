...
public class PluginTest extends JavaPlugin {
    ...
    public void onEnable(){
        String[] connection={"jdbc:mysql://localhost:3306","/Minecraft","?useSSL=false&serverTimezone=UTC", "root", "o0x79ybl"};
        DataBase.connection=connection;
        DataBase.createDB();
        DataBase.executeUpdate("CREATE TABLE IF NOT EXISTS users_data (mcuser varchar(255) not null, user varchar(255) not null, `group` varchar(255) not null, wealth decimal (65,2) not null, town varchar(255), last_seen datetime not null, register_date datetime not null,PRIMARY KEY(user))");
        ...
        DataBase.executeUpdate("CREATE TABLE IF NOT EXISTS chunks_town (x INT not null, z INT not null, town_name varchar(255) not null, owner varchar(255) not null, seized date, PRIMARY KEY(x,z))");
        ...
        this.getCommand("town").setExecutor(new Town(connection));
