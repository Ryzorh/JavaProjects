...
public class main {
    public static void main(String[] args){
        ...
        for (int i = 0; i < 512; i++) {
            for (int j = 0; j < 512; j++) {
                if((i-255)*(i-255)+(j-255)*(j-255)<255*255 && (i-255)*(i-255)+(j-255)*(j-255)>247*247){
                    ...
                    for(int k=0; k<section*16; k++){
                        Coordinate coord = new Coordinate(i, k, j);
                        Block block = new Block("minecraft:quartz_block");
        ...
        try {
            ...
            RegionFile rF= new RegionFile(new File("/home/eduard/MinecraftServers/Server01/world/region/r.0.0.mca"));
